...
<div id="tabs-1" style="width: 1600px;display: block">
    <div style="float: left; width: 400px;">
        ...
        <div>
            ...
            msg:<input class="textbox" type="text" id="test-http" style="width: 100px;"
                       value="http"/>
            <input type="button" value="发送" onclick="commonModule.httpSend()"/><br>
        </div>
        <div>
            <strong>[webSocket]</strong><br/>
            msg:<input class="textbox" type="text" id="test-websocket" style="width: 100px;"
                       value="webSocket"/>
            <input type="button" value="发送" onclick="commonModule.webSocketSend()"/><br>
        </div>
    </div>
</div>
